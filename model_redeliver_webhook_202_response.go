...
// checks if the RedeliverWebhook202Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RedeliverWebhook202Response{}

// RedeliverWebhook202Response struct for RedeliverWebhook202Response
type RedeliverWebhook202Response struct {
	Success bool `json:"success"`
	Data WebhookDeliveryResponse `json:"data"`
}

type _RedeliverWebhook202Response RedeliverWebhook202Response
...
func NewRedeliverWebhook202Response(success bool, data WebhookDeliveryResponse) *RedeliverWebhook202Response {
	this := RedeliverWebhook202Response{}
...
func (o RedeliverWebhook202Response) MarshalJSON() ([]byte, error) {
...
func (o RedeliverWebhook202Response) ToMap() (map[string]interface{}, error) {
...
func (o *RedeliverWebhook202Response) UnmarshalJSON(data []byte) (err error) {
	...
	varRedeliverWebhook202Response := _RedeliverWebhook202Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRedeliverWebhook202Response)

	if err != nil {
		return err
	}

	*o = RedeliverWebhook202Response(varRedeliverWebhook202Response)

	return err
}

type NullableRedeliverWebhook202Response struct {
	value *RedeliverWebhook202Response
	isSet bool
}

func (v NullableRedeliverWebhook202Response) Get() *RedeliverWebhook202Response {
	return v.value
}

func (v *NullableRedeliverWebhook202Response) Set(val *RedeliverWebhook202Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRedeliverWebhook202Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRedeliverWebhook202Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRedeliverWebhook202Response(val *RedeliverWebhook202Response) *NullableRedeliverWebhook202Response {
	return &NullableRedeliverWebhook202Response{value: val, isSet: true}
}

func (v NullableRedeliverWebhook202Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRedeliverWebhook202Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

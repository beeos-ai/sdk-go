...
// PartToolResultContent - JSON-encoded tool output. Plain text tool outputs SHOULD be wrapped as `{\"text\": \"...\"}` so the structural type stays uniform — but the schema accepts both for ergonomics. 
type PartToolResultContent struct {
	MapmapOfStringAny *map[string]interface{}
	String *string
}

// map[string]interface{}AsPartToolResultContent is a convenience function that returns map[string]interface{} wrapped in PartToolResultContent
func MapmapOfStringAnyAsPartToolResultContent(v *map[string]interface{}) PartToolResultContent {
	return PartToolResultContent{
		MapmapOfStringAny: v,
	}
}

// stringAsPartToolResultContent is a convenience function that returns string wrapped in PartToolResultContent
func StringAsPartToolResultContent(v *string) PartToolResultContent {
	return PartToolResultContent{
		String: v,
	}
}
...
func (dst *PartToolResultContent) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(PartToolResultContent)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(PartToolResultContent)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src PartToolResultContent) MarshalJSON() ([]byte, error) {
...
func (obj *PartToolResultContent) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj PartToolResultContent) GetActualInstanceValue() (interface{}) {
	if obj.MapmapOfStringAny != nil {
		return *obj.MapmapOfStringAny
	}
...
type NullablePartToolResultContent struct {
	value *PartToolResultContent
	isSet bool
}

func (v NullablePartToolResultContent) Get() *PartToolResultContent {
	return v.value
}

func (v *NullablePartToolResultContent) Set(val *PartToolResultContent) {
	v.value = val
	v.isSet = true
}

func (v NullablePartToolResultContent) IsSet() bool {
	return v.isSet
}

func (v *NullablePartToolResultContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartToolResultContent(val *PartToolResultContent) *NullablePartToolResultContent {
	return &NullablePartToolResultContent{value: val, isSet: true}
}

func (v NullablePartToolResultContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartToolResultContent) UnmarshalJSON(src []byte) error {
	v.isSet = true

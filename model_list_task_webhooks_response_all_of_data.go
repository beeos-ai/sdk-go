...
// checks if the ListTaskWebhooksResponseAllOfData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTaskWebhooksResponseAllOfData{}

// ListTaskWebhooksResponseAllOfData struct for ListTaskWebhooksResponseAllOfData
type ListTaskWebhooksResponseAllOfData struct {
	Webhooks []ListTaskWebhooksResponseAllOfDataWebhooks `json:"webhooks"`
}

type _ListTaskWebhooksResponseAllOfData ListTaskWebhooksResponseAllOfData

// NewListTaskWebhooksResponseAllOfData instantiates a new ListTaskWebhooksResponseAllOfData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListTaskWebhooksResponseAllOfData(webhooks []ListTaskWebhooksResponseAllOfDataWebhooks) *ListTaskWebhooksResponseAllOfData {
	this := ListTaskWebhooksResponseAllOfData{}
	this.Webhooks = webhooks
	return &this
}

// NewListTaskWebhooksResponseAllOfDataWithDefaults instantiates a new ListTaskWebhooksResponseAllOfData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListTaskWebhooksResponseAllOfDataWithDefaults() *ListTaskWebhooksResponseAllOfData {
	this := ListTaskWebhooksResponseAllOfData{}
	return &this
}

// GetWebhooks returns the Webhooks field value
func (o *ListTaskWebhooksResponseAllOfData) GetWebhooks() []ListTaskWebhooksResponseAllOfDataWebhooks {
	if o == nil {
		var ret []ListTaskWebhooksResponseAllOfDataWebhooks
		return ret
	}
...
func (o *ListTaskWebhooksResponseAllOfData) GetWebhooksOk() ([]ListTaskWebhooksResponseAllOfDataWebhooks, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListTaskWebhooksResponseAllOfData) SetWebhooks(v []ListTaskWebhooksResponseAllOfDataWebhooks) {
	o.Webhooks = v
}

func (o ListTaskWebhooksResponseAllOfData) MarshalJSON() ([]byte, error) {
...
func (o ListTaskWebhooksResponseAllOfData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["webhooks"] = o.Webhooks
	return toSerialize, nil
}

func (o *ListTaskWebhooksResponseAllOfData) UnmarshalJSON(data []byte) (err error) {
	...
	varListTaskWebhooksResponseAllOfData := _ListTaskWebhooksResponseAllOfData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTaskWebhooksResponseAllOfData)

	if err != nil {
		return err
	}

	*o = ListTaskWebhooksResponseAllOfData(varListTaskWebhooksResponseAllOfData)

	return err
}

type NullableListTaskWebhooksResponseAllOfData struct {
	value *ListTaskWebhooksResponseAllOfData
	isSet bool
}

func (v NullableListTaskWebhooksResponseAllOfData) Get() *ListTaskWebhooksResponseAllOfData {
	return v.value
}

func (v *NullableListTaskWebhooksResponseAllOfData) Set(val *ListTaskWebhooksResponseAllOfData) {
	v.value = val
	v.isSet = true
}

func (v NullableListTaskWebhooksResponseAllOfData) IsSet() bool {
	return v.isSet
}

func (v *NullableListTaskWebhooksResponseAllOfData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTaskWebhooksResponseAllOfData(val *ListTaskWebhooksResponseAllOfData) *NullableListTaskWebhooksResponseAllOfData {
	return &NullableListTaskWebhooksResponseAllOfData{value: val, isSet: true}
}

func (v NullableListTaskWebhooksResponseAllOfData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTaskWebhooksResponseAllOfData) UnmarshalJSON(src []byte) error {
	v.isSet = true

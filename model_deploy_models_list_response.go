...
// checks if the DeployModelsListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeployModelsListResponse{}
...
type _DeployModelsListResponse DeployModelsListResponse
...
func (o *DeployModelsListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDeployModelsListResponse := _DeployModelsListResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeployModelsListResponse)

	if err != nil {
		return err
	}

	*o = DeployModelsListResponse(varDeployModelsListResponse)

	return err
}

type NullableDeployModelsListResponse struct {
	value *DeployModelsListResponse
	isSet bool
}

func (v NullableDeployModelsListResponse) Get() *DeployModelsListResponse {
	return v.value
}

func (v *NullableDeployModelsListResponse) Set(val *DeployModelsListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDeployModelsListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDeployModelsListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeployModelsListResponse(val *DeployModelsListResponse) *NullableDeployModelsListResponse {
	return &NullableDeployModelsListResponse{value: val, isSet: true}
}

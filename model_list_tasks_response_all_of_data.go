...
// checks if the ListTasksResponseAllOfData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasksResponseAllOfData{}

// ListTasksResponseAllOfData struct for ListTasksResponseAllOfData
type ListTasksResponseAllOfData struct {
	Tasks []TaskSummary `json:"tasks"`
	// Pagination cursor. Empty when the caller has reached the end of results. 
	NextSince *string `json:"next_since,omitempty"`
}

type _ListTasksResponseAllOfData ListTasksResponseAllOfData
...
func NewListTasksResponseAllOfData(tasks []TaskSummary) *ListTasksResponseAllOfData {
	this := ListTasksResponseAllOfData{}
	this.Tasks = tasks
	return &this
}
...
func (o ListTasksResponseAllOfData) MarshalJSON() ([]byte, error) {
...
func (o ListTasksResponseAllOfData) ToMap() (map[string]interface{}, error) {
...
func (o *ListTasksResponseAllOfData) UnmarshalJSON(data []byte) (err error) {
	...
	varListTasksResponseAllOfData := _ListTasksResponseAllOfData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTasksResponseAllOfData)

	if err != nil {
		return err
	}

	*o = ListTasksResponseAllOfData(varListTasksResponseAllOfData)

	return err
}

type NullableListTasksResponseAllOfData struct {
	value *ListTasksResponseAllOfData
	isSet bool
}

func (v NullableListTasksResponseAllOfData) Get() *ListTasksResponseAllOfData {
	return v.value
}

func (v *NullableListTasksResponseAllOfData) Set(val *ListTasksResponseAllOfData) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasksResponseAllOfData) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasksResponseAllOfData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasksResponseAllOfData(val *ListTasksResponseAllOfData) *NullableListTasksResponseAllOfData {
	return &NullableListTasksResponseAllOfData{value: val, isSet: true}
}

func (v NullableListTasksResponseAllOfData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasksResponseAllOfData) UnmarshalJSON(src []byte) error {
	v.isSet = true

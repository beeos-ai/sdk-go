...
// checks if the UITreeResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UITreeResult{}

// UITreeResult struct for UITreeResult
type UITreeResult struct {
	Supported bool   `json:"supported"`
	Content   string `json:"content"`
}

type _UITreeResult UITreeResult

// NewUITreeResult instantiates a new UITreeResult object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUITreeResult(supported bool, content string) *UITreeResult {
	this := UITreeResult{}
...
// NewUITreeResultWithDefaults instantiates a new UITreeResult object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUITreeResultWithDefaults() *UITreeResult {
	this := UITreeResult{}
	return &this
}

// GetSupported returns the Supported field value
func (o *UITreeResult) GetSupported() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
func (o *UITreeResult) GetSupportedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UITreeResult) SetSupported(v bool) {
	o.Supported = v
}

// GetContent returns the Content field value
func (o *UITreeResult) GetContent() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UITreeResult) GetContentOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UITreeResult) SetContent(v string) {
	o.Content = v
}

func (o UITreeResult) MarshalJSON() ([]byte, error) {
...
func (o UITreeResult) ToMap() (map[string]interface{}, error) {
...
func (o *UITreeResult) UnmarshalJSON(data []byte) (err error) {
	...
	varUITreeResult := _UITreeResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUITreeResult)

	if err != nil {
		return err
	}

	*o = UITreeResult(varUITreeResult)

	return err
}

type NullableUITreeResult struct {
	value *UITreeResult
	isSet bool
}

func (v NullableUITreeResult) Get() *UITreeResult {
	return v.value
}

func (v *NullableUITreeResult) Set(val *UITreeResult) {
	v.value = val
	v.isSet = true
}

func (v NullableUITreeResult) IsSet() bool {
	return v.isSet
}

func (v *NullableUITreeResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUITreeResult(val *UITreeResult) *NullableUITreeResult {
	return &NullableUITreeResult{value: val, isSet: true}
}

func (v NullableUITreeResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUITreeResult) UnmarshalJSON(src []byte) error {
	v.isSet = true

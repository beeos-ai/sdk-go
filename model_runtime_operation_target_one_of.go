...
// checks if the RuntimeOperationTargetOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuntimeOperationTargetOneOf{}

// RuntimeOperationTargetOneOf struct for RuntimeOperationTargetOneOf
type RuntimeOperationTargetOneOf struct {
	Scope string `json:"scope"`
	AdditionalProperties map[string]interface{}
}

type _RuntimeOperationTargetOneOf RuntimeOperationTargetOneOf

// NewRuntimeOperationTargetOneOf instantiates a new RuntimeOperationTargetOneOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRuntimeOperationTargetOneOf(scope string) *RuntimeOperationTargetOneOf {
	this := RuntimeOperationTargetOneOf{}
	this.Scope = scope
	return &this
}

// NewRuntimeOperationTargetOneOfWithDefaults instantiates a new RuntimeOperationTargetOneOf object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRuntimeOperationTargetOneOfWithDefaults() *RuntimeOperationTargetOneOf {
	this := RuntimeOperationTargetOneOf{}
	return &this
}

// GetScope returns the Scope field value
func (o *RuntimeOperationTargetOneOf) GetScope() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *RuntimeOperationTargetOneOf) GetScopeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Scope, true
...
func (o *RuntimeOperationTargetOneOf) SetScope(v string) {
	o.Scope = v
}

func (o RuntimeOperationTargetOneOf) MarshalJSON() ([]byte, error) {
...
func (o RuntimeOperationTargetOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *RuntimeOperationTargetOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varRuntimeOperationTargetOneOf := _RuntimeOperationTargetOneOf{}

	err = json.Unmarshal(data, &varRuntimeOperationTargetOneOf)

	if err != nil {
		return err
	}

	*o = RuntimeOperationTargetOneOf(varRuntimeOperationTargetOneOf)
...
type NullableRuntimeOperationTargetOneOf struct {
	value *RuntimeOperationTargetOneOf
	isSet bool
}

func (v NullableRuntimeOperationTargetOneOf) Get() *RuntimeOperationTargetOneOf {
	return v.value
}

func (v *NullableRuntimeOperationTargetOneOf) Set(val *RuntimeOperationTargetOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRuntimeOperationTargetOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRuntimeOperationTargetOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuntimeOperationTargetOneOf(val *RuntimeOperationTargetOneOf) *NullableRuntimeOperationTargetOneOf {
	return &NullableRuntimeOperationTargetOneOf{value: val, isSet: true}
}

func (v NullableRuntimeOperationTargetOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuntimeOperationTargetOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

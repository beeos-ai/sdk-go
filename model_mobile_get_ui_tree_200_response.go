...
// checks if the MobileGetUiTree200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MobileGetUiTree200Response{}

// MobileGetUiTree200Response struct for MobileGetUiTree200Response
type MobileGetUiTree200Response struct {
	Success bool          `json:"success"`
	Data    *UITreeResult `json:"data,omitempty"`
}

type _MobileGetUiTree200Response MobileGetUiTree200Response
...
func NewMobileGetUiTree200Response(success bool) *MobileGetUiTree200Response {
	this := MobileGetUiTree200Response{}
...
// SetData gets a reference to the given UITreeResult and assigns it to the Data field.
func (o *MobileGetUiTree200Response) SetData(v UITreeResult) {
	o.Data = &v
}

func (o MobileGetUiTree200Response) MarshalJSON() ([]byte, error) {
...
func (o MobileGetUiTree200Response) ToMap() (map[string]interface{}, error) {
...
func (o *MobileGetUiTree200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varMobileGetUiTree200Response := _MobileGetUiTree200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMobileGetUiTree200Response)

	if err != nil {
		return err
	}

	*o = MobileGetUiTree200Response(varMobileGetUiTree200Response)

	return err
}

type NullableMobileGetUiTree200Response struct {
	value *MobileGetUiTree200Response
	isSet bool
}

func (v NullableMobileGetUiTree200Response) Get() *MobileGetUiTree200Response {
	return v.value
}

func (v *NullableMobileGetUiTree200Response) Set(val *MobileGetUiTree200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMobileGetUiTree200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMobileGetUiTree200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobileGetUiTree200Response(val *MobileGetUiTree200Response) *NullableMobileGetUiTree200Response {
	return &NullableMobileGetUiTree200Response{value: val, isSet: true}
}

func (v NullableMobileGetUiTree200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobileGetUiTree200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

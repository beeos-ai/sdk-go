...
// checks if the ListTaskWebhooksResponseAllOfDataWebhooks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTaskWebhooksResponseAllOfDataWebhooks{}

// ListTaskWebhooksResponseAllOfDataWebhooks struct for ListTaskWebhooksResponseAllOfDataWebhooks
type ListTaskWebhooksResponseAllOfDataWebhooks struct {
...
type _ListTaskWebhooksResponseAllOfDataWebhooks ListTaskWebhooksResponseAllOfDataWebhooks
...
func NewListTaskWebhooksResponseAllOfDataWebhooks(webhookId string, taskId string, url string, hasSecret bool) *ListTaskWebhooksResponseAllOfDataWebhooks {
	this := ListTaskWebhooksResponseAllOfDataWebhooks{}
...
func (o ListTaskWebhooksResponseAllOfDataWebhooks) MarshalJSON() ([]byte, error) {
...
func (o ListTaskWebhooksResponseAllOfDataWebhooks) ToMap() (map[string]interface{}, error) {
...
func (o *ListTaskWebhooksResponseAllOfDataWebhooks) UnmarshalJSON(data []byte) (err error) {
	...
	varListTaskWebhooksResponseAllOfDataWebhooks := _ListTaskWebhooksResponseAllOfDataWebhooks{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTaskWebhooksResponseAllOfDataWebhooks)

	if err != nil {
		return err
	}

	*o = ListTaskWebhooksResponseAllOfDataWebhooks(varListTaskWebhooksResponseAllOfDataWebhooks)

	return err
}

type NullableListTaskWebhooksResponseAllOfDataWebhooks struct {
	value *ListTaskWebhooksResponseAllOfDataWebhooks
	isSet bool
}

func (v NullableListTaskWebhooksResponseAllOfDataWebhooks) Get() *ListTaskWebhooksResponseAllOfDataWebhooks {
	return v.value
}

func (v *NullableListTaskWebhooksResponseAllOfDataWebhooks) Set(val *ListTaskWebhooksResponseAllOfDataWebhooks) {
	v.value = val
	v.isSet = true
}

func (v NullableListTaskWebhooksResponseAllOfDataWebhooks) IsSet() bool {
	return v.isSet
}

func (v *NullableListTaskWebhooksResponseAllOfDataWebhooks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTaskWebhooksResponseAllOfDataWebhooks(val *ListTaskWebhooksResponseAllOfDataWebhooks) *NullableListTaskWebhooksResponseAllOfDataWebhooks {
	return &NullableListTaskWebhooksResponseAllOfDataWebhooks{value: val, isSet: true}
}

func (v NullableListTaskWebhooksResponseAllOfDataWebhooks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTaskWebhooksResponseAllOfDataWebhooks) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the SwipeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SwipeRequest{}

// SwipeRequest struct for SwipeRequest
type SwipeRequest struct {
	X1 int32 `json:"x1"`
	Y1 int32 `json:"y1"`
	X2 int32 `json:"x2"`
	Y2 int32 `json:"y2"`
	// Gesture duration; clamped device-side to [1, 10000].
	DurationMs *int32 `json:"duration_ms,omitempty"`
}

type _SwipeRequest SwipeRequest
...
func (o SwipeRequest) MarshalJSON() ([]byte, error) {
...
func (o SwipeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SwipeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSwipeRequest := _SwipeRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSwipeRequest)

	if err != nil {
		return err
	}

	*o = SwipeRequest(varSwipeRequest)

	return err
}

type NullableSwipeRequest struct {
	value *SwipeRequest
	isSet bool
}

func (v NullableSwipeRequest) Get() *SwipeRequest {
	return v.value
}

func (v *NullableSwipeRequest) Set(val *SwipeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSwipeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSwipeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSwipeRequest(val *SwipeRequest) *NullableSwipeRequest {
	return &NullableSwipeRequest{value: val, isSet: true}
}

func (v NullableSwipeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSwipeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

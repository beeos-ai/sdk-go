...
// checks if the RuntimeOperationTargetOneOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuntimeOperationTargetOneOf2{}

// RuntimeOperationTargetOneOf2 struct for RuntimeOperationTargetOneOf2
type RuntimeOperationTargetOneOf2 struct {
...
type _RuntimeOperationTargetOneOf2 RuntimeOperationTargetOneOf2

// NewRuntimeOperationTargetOneOf2 instantiates a new RuntimeOperationTargetOneOf2 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRuntimeOperationTargetOneOf2(scope string, platformAgentId string, conversationId string) *RuntimeOperationTargetOneOf2 {
	this := RuntimeOperationTargetOneOf2{}
	this.Scope = scope
...
// NewRuntimeOperationTargetOneOf2WithDefaults instantiates a new RuntimeOperationTargetOneOf2 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRuntimeOperationTargetOneOf2WithDefaults() *RuntimeOperationTargetOneOf2 {
	this := RuntimeOperationTargetOneOf2{}
	return &this
}

// GetScope returns the Scope field value
func (o *RuntimeOperationTargetOneOf2) GetScope() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *RuntimeOperationTargetOneOf2) GetScopeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Scope, true
...
func (o *RuntimeOperationTargetOneOf2) SetScope(v string) {
	o.Scope = v
}

// GetPlatformAgentId returns the PlatformAgentId field value
func (o *RuntimeOperationTargetOneOf2) GetPlatformAgentId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RuntimeOperationTargetOneOf2) GetPlatformAgentIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RuntimeOperationTargetOneOf2) SetPlatformAgentId(v string) {
	o.PlatformAgentId = v
}

// GetConversationId returns the ConversationId field value
func (o *RuntimeOperationTargetOneOf2) GetConversationId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RuntimeOperationTargetOneOf2) GetConversationIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RuntimeOperationTargetOneOf2) SetConversationId(v string) {
	o.ConversationId = v
}

func (o RuntimeOperationTargetOneOf2) MarshalJSON() ([]byte, error) {
...
func (o RuntimeOperationTargetOneOf2) ToMap() (map[string]interface{}, error) {
...
func (o *RuntimeOperationTargetOneOf2) UnmarshalJSON(data []byte) (err error) {
	...
	varRuntimeOperationTargetOneOf2 := _RuntimeOperationTargetOneOf2{}

	err = json.Unmarshal(data, &varRuntimeOperationTargetOneOf2)

	if err != nil {
		return err
	}

	*o = RuntimeOperationTargetOneOf2(varRuntimeOperationTargetOneOf2)
...
type NullableRuntimeOperationTargetOneOf2 struct {
	value *RuntimeOperationTargetOneOf2
	isSet bool
}

func (v NullableRuntimeOperationTargetOneOf2) Get() *RuntimeOperationTargetOneOf2 {
	return v.value
}

func (v *NullableRuntimeOperationTargetOneOf2) Set(val *RuntimeOperationTargetOneOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableRuntimeOperationTargetOneOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableRuntimeOperationTargetOneOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuntimeOperationTargetOneOf2(val *RuntimeOperationTargetOneOf2) *NullableRuntimeOperationTargetOneOf2 {
	return &NullableRuntimeOperationTargetOneOf2{value: val, isSet: true}
}

func (v NullableRuntimeOperationTargetOneOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuntimeOperationTargetOneOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true

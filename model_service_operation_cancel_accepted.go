...
// checks if the ServiceOperationCancelAccepted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceOperationCancelAccepted{}

// ServiceOperationCancelAccepted struct for ServiceOperationCancelAccepted
type ServiceOperationCancelAccepted struct {
	Status string `json:"status"`
	OperationId string `json:"operationId"`
	AdditionalProperties map[string]interface{}
}

type _ServiceOperationCancelAccepted ServiceOperationCancelAccepted

// NewServiceOperationCancelAccepted instantiates a new ServiceOperationCancelAccepted object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewServiceOperationCancelAccepted(status string, operationId string) *ServiceOperationCancelAccepted {
	this := ServiceOperationCancelAccepted{}
	this.Status = status
	this.OperationId = operationId
	return &this
}

// NewServiceOperationCancelAcceptedWithDefaults instantiates a new ServiceOperationCancelAccepted object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewServiceOperationCancelAcceptedWithDefaults() *ServiceOperationCancelAccepted {
	this := ServiceOperationCancelAccepted{}
	return &this
}

// GetStatus returns the Status field value
func (o *ServiceOperationCancelAccepted) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ServiceOperationCancelAccepted) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServiceOperationCancelAccepted) SetStatus(v string) {
	o.Status = v
}

// GetOperationId returns the OperationId field value
func (o *ServiceOperationCancelAccepted) GetOperationId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ServiceOperationCancelAccepted) GetOperationIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServiceOperationCancelAccepted) SetOperationId(v string) {
	o.OperationId = v
}

func (o ServiceOperationCancelAccepted) MarshalJSON() ([]byte, error) {
...
func (o ServiceOperationCancelAccepted) ToMap() (map[string]interface{}, error) {
...
func (o *ServiceOperationCancelAccepted) UnmarshalJSON(data []byte) (err error) {
	...
	varServiceOperationCancelAccepted := _ServiceOperationCancelAccepted{}

	err = json.Unmarshal(data, &varServiceOperationCancelAccepted)

	if err != nil {
		return err
	}

	*o = ServiceOperationCancelAccepted(varServiceOperationCancelAccepted)
...
type NullableServiceOperationCancelAccepted struct {
	value *ServiceOperationCancelAccepted
	isSet bool
}

func (v NullableServiceOperationCancelAccepted) Get() *ServiceOperationCancelAccepted {
	return v.value
}

func (v *NullableServiceOperationCancelAccepted) Set(val *ServiceOperationCancelAccepted) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceOperationCancelAccepted) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceOperationCancelAccepted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceOperationCancelAccepted(val *ServiceOperationCancelAccepted) *NullableServiceOperationCancelAccepted {
	return &NullableServiceOperationCancelAccepted{value: val, isSet: true}
}

func (v NullableServiceOperationCancelAccepted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceOperationCancelAccepted) UnmarshalJSON(src []byte) error {
	v.isSet = true

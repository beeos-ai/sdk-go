...
// checks if the TaskWebhookResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskWebhookResponse{}

// TaskWebhookResponse struct for TaskWebhookResponse
type TaskWebhookResponse struct {
	Success bool `json:"success"`
	Data TaskWebhookResponseAllOfData `json:"data"`
}

type _TaskWebhookResponse TaskWebhookResponse
...
func (o *TaskWebhookResponse) GetData() TaskWebhookResponseAllOfData {
	if o == nil {
		var ret TaskWebhookResponseAllOfData
		return ret
	}
...
func (o TaskWebhookResponse) MarshalJSON() ([]byte, error) {
...
func (o TaskWebhookResponse) ToMap() (map[string]interface{}, error) {
...
func (o *TaskWebhookResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskWebhookResponse := _TaskWebhookResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTaskWebhookResponse)

	if err != nil {
		return err
	}

	*o = TaskWebhookResponse(varTaskWebhookResponse)

	return err
}

type NullableTaskWebhookResponse struct {
	value *TaskWebhookResponse
	isSet bool
}

func (v NullableTaskWebhookResponse) Get() *TaskWebhookResponse {
	return v.value
}

func (v *NullableTaskWebhookResponse) Set(val *TaskWebhookResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskWebhookResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskWebhookResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskWebhookResponse(val *TaskWebhookResponse) *NullableTaskWebhookResponse {
	return &NullableTaskWebhookResponse{value: val, isSet: true}
}

func (v NullableTaskWebhookResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskWebhookResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

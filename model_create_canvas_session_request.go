...
// checks if the CreateCanvasSessionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCanvasSessionRequest{}

// CreateCanvasSessionRequest struct for CreateCanvasSessionRequest
type CreateCanvasSessionRequest struct {
	PlatformAgentId string `json:"platformAgentId"`
	ConversationId string `json:"conversationId"`
	// Opaque Canvas/A2UI surface identifier; not a UUID
	CanvasId *string `json:"canvasId,omitempty" validate:"regexp=^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$"`
	AdditionalProperties map[string]interface{}
}

type _CreateCanvasSessionRequest CreateCanvasSessionRequest
...
func NewCreateCanvasSessionRequest(platformAgentId string, conversationId string) *CreateCanvasSessionRequest {
	this := CreateCanvasSessionRequest{}
...
func (o CreateCanvasSessionRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateCanvasSessionRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateCanvasSessionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCanvasSessionRequest := _CreateCanvasSessionRequest{}

	err = json.Unmarshal(data, &varCreateCanvasSessionRequest)

	if err != nil {
		return err
	}

	*o = CreateCanvasSessionRequest(varCreateCanvasSessionRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "canvasId")
...
type NullableCreateCanvasSessionRequest struct {
	value *CreateCanvasSessionRequest
	isSet bool
}

func (v NullableCreateCanvasSessionRequest) Get() *CreateCanvasSessionRequest {
	return v.value
}

func (v *NullableCreateCanvasSessionRequest) Set(val *CreateCanvasSessionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCanvasSessionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCanvasSessionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCanvasSessionRequest(val *CreateCanvasSessionRequest) *NullableCreateCanvasSessionRequest {
	return &NullableCreateCanvasSessionRequest{value: val, isSet: true}
}

func (v NullableCreateCanvasSessionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCanvasSessionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

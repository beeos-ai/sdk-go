...
func (o *MoveRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varMoveRequest := _MoveRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMoveRequest)

	if err != nil {
		return err
	}

	*o = MoveRequest(varMoveRequest)

...
type _AppListResult AppListResult
...
func (o *AppListResult) UnmarshalJSON(data []byte) (err error) {
	...
	varAppListResult := _AppListResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppListResult)

	if err != nil {
		return err
	}

	*o = AppListResult(varAppListResult)

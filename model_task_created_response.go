...
// checks if the TaskCreatedResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskCreatedResponse{}

// TaskCreatedResponse struct for TaskCreatedResponse
type TaskCreatedResponse struct {
	Success bool `json:"success"`
	Data TaskCreatedResponseAllOfData `json:"data"`
}

type _TaskCreatedResponse TaskCreatedResponse
...
func (o *TaskCreatedResponse) GetData() TaskCreatedResponseAllOfData {
	if o == nil {
		var ret TaskCreatedResponseAllOfData
		return ret
	}
...
func (o TaskCreatedResponse) MarshalJSON() ([]byte, error) {
...
func (o TaskCreatedResponse) ToMap() (map[string]interface{}, error) {
...
func (o *TaskCreatedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskCreatedResponse := _TaskCreatedResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTaskCreatedResponse)

	if err != nil {
		return err
	}

	*o = TaskCreatedResponse(varTaskCreatedResponse)

	return err
}

type NullableTaskCreatedResponse struct {
	value *TaskCreatedResponse
	isSet bool
}

func (v NullableTaskCreatedResponse) Get() *TaskCreatedResponse {
	return v.value
}

func (v *NullableTaskCreatedResponse) Set(val *TaskCreatedResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskCreatedResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskCreatedResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskCreatedResponse(val *TaskCreatedResponse) *NullableTaskCreatedResponse {
	return &NullableTaskCreatedResponse{value: val, isSet: true}
}

func (v NullableTaskCreatedResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskCreatedResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

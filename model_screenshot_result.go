...
// checks if the ScreenshotResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScreenshotResult{}

// ScreenshotResult A captured screenshot staged in BeeOS file storage. The image is referenced by `file_id` + a short-lived presigned `url`, never inline base64. 
type ScreenshotResult struct {
	// Stable BeeOS file id (resolvable via `GET /files/{id}`).
	FileId string `json:"file_id"`
	// Short-lived presigned download URL for the image.
	Url string `json:"url"`
	// Image codec (`png` / `jpeg`).
	Format *string `json:"format,omitempty"`
	Width *int32 `json:"width,omitempty"`
	Height *int32 `json:"height,omitempty"`
}

type _ScreenshotResult ScreenshotResult
...
func (o ScreenshotResult) MarshalJSON() ([]byte, error) {
...
func (o ScreenshotResult) ToMap() (map[string]interface{}, error) {
...
func (o *ScreenshotResult) UnmarshalJSON(data []byte) (err error) {
	...
	varScreenshotResult := _ScreenshotResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScreenshotResult)

	if err != nil {
		return err
	}

	*o = ScreenshotResult(varScreenshotResult)

	return err
}

type NullableScreenshotResult struct {
	value *ScreenshotResult
	isSet bool
}

func (v NullableScreenshotResult) Get() *ScreenshotResult {
	return v.value
}

func (v *NullableScreenshotResult) Set(val *ScreenshotResult) {
	v.value = val
	v.isSet = true
}

func (v NullableScreenshotResult) IsSet() bool {
	return v.isSet
}

func (v *NullableScreenshotResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScreenshotResult(val *ScreenshotResult) *NullableScreenshotResult {
	return &NullableScreenshotResult{value: val, isSet: true}
}

func (v NullableScreenshotResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScreenshotResult) UnmarshalJSON(src []byte) error {
	v.isSet = true

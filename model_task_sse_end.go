...
// checks if the TaskSSEEnd type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskSSEEnd{}

// TaskSSEEnd Body of the terminal `event: end` frame. SDKs treat any value as a clean shutdown signal; the `reason` field disambiguates whether the agent terminated (`task_terminal`), MS closed the upstream stream (`stream_closed`), or the conversation channel was deleted (`channel_closed`). 
type TaskSSEEnd struct {
	Reason string `json:"reason"`
}

type _TaskSSEEnd TaskSSEEnd
...
func (o TaskSSEEnd) MarshalJSON() ([]byte, error) {
...
func (o TaskSSEEnd) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["reason"] = o.Reason
	return toSerialize, nil
}

func (o *TaskSSEEnd) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskSSEEnd := _TaskSSEEnd{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTaskSSEEnd)

	if err != nil {
		return err
	}

	*o = TaskSSEEnd(varTaskSSEEnd)

	return err
}

type NullableTaskSSEEnd struct {
	value *TaskSSEEnd
	isSet bool
}

func (v NullableTaskSSEEnd) Get() *TaskSSEEnd {
	return v.value
}

func (v *NullableTaskSSEEnd) Set(val *TaskSSEEnd) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskSSEEnd) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskSSEEnd) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskSSEEnd(val *TaskSSEEnd) *NullableTaskSSEEnd {
	return &NullableTaskSSEEnd{value: val, isSet: true}
}

func (v NullableTaskSSEEnd) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskSSEEnd) UnmarshalJSON(src []byte) error {
	v.isSet = true

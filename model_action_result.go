...
// ActionResult Generic acknowledgement that a mutating control action completed.
...
func NewActionResult(ok bool) *ActionResult {
	this := ActionResult{}
	this.Ok = ok
	return &this
}
...
func (o *ActionResult) GetOk() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
func (o *ActionResult) GetOkOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Ok, true
...
func (o *ActionResult) SetOk(v bool) {
	o.Ok = v
}

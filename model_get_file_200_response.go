...
type GetFile200Response struct {
	...
	Data *FileMetaResponse `json:"data,omitempty"`
}
...
// SetData gets a reference to the given FileMetaResponse and assigns it to the Data field.

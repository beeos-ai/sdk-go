...
// checks if the RuntimeOperationSnapshotCancelRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuntimeOperationSnapshotCancelRequest{}

// RuntimeOperationSnapshotCancelRequest struct for RuntimeOperationSnapshotCancelRequest
type RuntimeOperationSnapshotCancelRequest struct {
...
type _RuntimeOperationSnapshotCancelRequest RuntimeOperationSnapshotCancelRequest
...
func NewRuntimeOperationSnapshotCancelRequest(requestedBy string, requestedAt time.Time) *RuntimeOperationSnapshotCancelRequest {
	this := RuntimeOperationSnapshotCancelRequest{}
...
func (o RuntimeOperationSnapshotCancelRequest) MarshalJSON() ([]byte, error) {
...
func (o RuntimeOperationSnapshotCancelRequest) ToMap() (map[string]interface{}, error) {
...
func (o *RuntimeOperationSnapshotCancelRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRuntimeOperationSnapshotCancelRequest := _RuntimeOperationSnapshotCancelRequest{}

	err = json.Unmarshal(data, &varRuntimeOperationSnapshotCancelRequest)

	if err != nil {
		return err
	}

	*o = RuntimeOperationSnapshotCancelRequest(varRuntimeOperationSnapshotCancelRequest)
...
type NullableRuntimeOperationSnapshotCancelRequest struct {
	value *RuntimeOperationSnapshotCancelRequest
	isSet bool
}

func (v NullableRuntimeOperationSnapshotCancelRequest) Get() *RuntimeOperationSnapshotCancelRequest {
	return v.value
}

func (v *NullableRuntimeOperationSnapshotCancelRequest) Set(val *RuntimeOperationSnapshotCancelRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRuntimeOperationSnapshotCancelRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRuntimeOperationSnapshotCancelRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuntimeOperationSnapshotCancelRequest(val *RuntimeOperationSnapshotCancelRequest) *NullableRuntimeOperationSnapshotCancelRequest {
	return &NullableRuntimeOperationSnapshotCancelRequest{value: val, isSet: true}
}

func (v NullableRuntimeOperationSnapshotCancelRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuntimeOperationSnapshotCancelRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the InvokeAgentSSEDelta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvokeAgentSSEDelta{}

// InvokeAgentSSEDelta struct for InvokeAgentSSEDelta
type InvokeAgentSSEDelta struct {
	Type string `json:"type"`
	// Streaming chunk text. Concatenate in order for the full reply.
	Text string `json:"text"`
}

type _InvokeAgentSSEDelta InvokeAgentSSEDelta

// NewInvokeAgentSSEDelta instantiates a new InvokeAgentSSEDelta object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInvokeAgentSSEDelta(type_ string, text string) *InvokeAgentSSEDelta {
	this := InvokeAgentSSEDelta{}
	this.Type = type_
	this.Text = text
	return &this
}

// NewInvokeAgentSSEDeltaWithDefaults instantiates a new InvokeAgentSSEDelta object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInvokeAgentSSEDeltaWithDefaults() *InvokeAgentSSEDelta {
	this := InvokeAgentSSEDelta{}
	return &this
}

// GetType returns the Type field value
func (o *InvokeAgentSSEDelta) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InvokeAgentSSEDelta) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *InvokeAgentSSEDelta) SetType(v string) {
	o.Type = v
}

// GetText returns the Text field value
func (o *InvokeAgentSSEDelta) GetText() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InvokeAgentSSEDelta) GetTextOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Text, true
...
func (o *InvokeAgentSSEDelta) SetText(v string) {
	o.Text = v
}

func (o InvokeAgentSSEDelta) MarshalJSON() ([]byte, error) {
...
func (o InvokeAgentSSEDelta) ToMap() (map[string]interface{}, error) {
...
func (o *InvokeAgentSSEDelta) UnmarshalJSON(data []byte) (err error) {
	...
	varInvokeAgentSSEDelta := _InvokeAgentSSEDelta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInvokeAgentSSEDelta)

	if err != nil {
		return err
	}

	*o = InvokeAgentSSEDelta(varInvokeAgentSSEDelta)

	return err
}

type NullableInvokeAgentSSEDelta struct {
	value *InvokeAgentSSEDelta
	isSet bool
}

func (v NullableInvokeAgentSSEDelta) Get() *InvokeAgentSSEDelta {
	return v.value
}

func (v *NullableInvokeAgentSSEDelta) Set(val *InvokeAgentSSEDelta) {
	v.value = val
	v.isSet = true
}

func (v NullableInvokeAgentSSEDelta) IsSet() bool {
	return v.isSet
}

func (v *NullableInvokeAgentSSEDelta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvokeAgentSSEDelta(val *InvokeAgentSSEDelta) *NullableInvokeAgentSSEDelta {
	return &NullableInvokeAgentSSEDelta{value: val, isSet: true}
}

func (v NullableInvokeAgentSSEDelta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvokeAgentSSEDelta) UnmarshalJSON(src []byte) error {
	v.isSet = true

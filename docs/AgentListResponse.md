...
**Total** | **int64** |  | 
**Projection** | Pointer to [**InstanceProjectionMetadata**](InstanceProjectionMetadata.md) |  | [optional] 
...
`func (o *AgentListResponse) GetProjection() InstanceProjectionMetadata`

GetProjection returns the Projection field if non-nil, zero value otherwise.

### GetProjectionOk

`func (o *AgentListResponse) GetProjectionOk() (*InstanceProjectionMetadata, bool)`
...
`func (o *AgentListResponse) SetProjection(v InstanceProjectionMetadata)`

SetProjection sets Projection field to given value.

### HasProjection

`func (o *AgentListResponse) HasProjection() bool`

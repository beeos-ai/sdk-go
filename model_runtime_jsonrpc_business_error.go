...
// checks if the RuntimeJSONRPCBusinessError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuntimeJSONRPCBusinessError{}

// RuntimeJSONRPCBusinessError struct for RuntimeJSONRPCBusinessError
type RuntimeJSONRPCBusinessError struct {
	Jsonrpc interface{} `json:"jsonrpc"`
	Id interface{} `json:"id"`
	Error RuntimeJSONRPCBusinessErrorError `json:"error"`
	AdditionalProperties map[string]interface{}
}

type _RuntimeJSONRPCBusinessError RuntimeJSONRPCBusinessError

// NewRuntimeJSONRPCBusinessError instantiates a new RuntimeJSONRPCBusinessError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRuntimeJSONRPCBusinessError(jsonrpc interface{}, id interface{}, error_ RuntimeJSONRPCBusinessErrorError) *RuntimeJSONRPCBusinessError {
	this := RuntimeJSONRPCBusinessError{}
...
// NewRuntimeJSONRPCBusinessErrorWithDefaults instantiates a new RuntimeJSONRPCBusinessError object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRuntimeJSONRPCBusinessErrorWithDefaults() *RuntimeJSONRPCBusinessError {
	this := RuntimeJSONRPCBusinessError{}
	return &this
}
...
func (o *RuntimeJSONRPCBusinessError) GetJsonrpc() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *RuntimeJSONRPCBusinessError) GetJsonrpcOk() (*interface{}, bool) {
...
func (o *RuntimeJSONRPCBusinessError) SetJsonrpc(v interface{}) {
	o.Jsonrpc = v
}

// GetId returns the Id field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *RuntimeJSONRPCBusinessError) GetId() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RuntimeJSONRPCBusinessError) GetIdOk() (*interface{}, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return &o.Id, true
...
func (o *RuntimeJSONRPCBusinessError) SetId(v interface{}) {
	o.Id = v
}

// GetError returns the Error field value
func (o *RuntimeJSONRPCBusinessError) GetError() RuntimeJSONRPCBusinessErrorError {
	if o == nil {
		var ret RuntimeJSONRPCBusinessErrorError
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RuntimeJSONRPCBusinessError) GetErrorOk() (*RuntimeJSONRPCBusinessErrorError, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Error, true
...
func (o *RuntimeJSONRPCBusinessError) SetError(v RuntimeJSONRPCBusinessErrorError) {
	o.Error = v
}

func (o RuntimeJSONRPCBusinessError) MarshalJSON() ([]byte, error) {
...
func (o RuntimeJSONRPCBusinessError) ToMap() (map[string]interface{}, error) {
...
func (o *RuntimeJSONRPCBusinessError) UnmarshalJSON(data []byte) (err error) {
	...
	varRuntimeJSONRPCBusinessError := _RuntimeJSONRPCBusinessError{}

	err = json.Unmarshal(data, &varRuntimeJSONRPCBusinessError)

	if err != nil {
		return err
	}

	*o = RuntimeJSONRPCBusinessError(varRuntimeJSONRPCBusinessError)
...
type NullableRuntimeJSONRPCBusinessError struct {
	value *RuntimeJSONRPCBusinessError
	isSet bool
}

func (v NullableRuntimeJSONRPCBusinessError) Get() *RuntimeJSONRPCBusinessError {
	return v.value
}

func (v *NullableRuntimeJSONRPCBusinessError) Set(val *RuntimeJSONRPCBusinessError) {
	v.value = val
	v.isSet = true
}

func (v NullableRuntimeJSONRPCBusinessError) IsSet() bool {
	return v.isSet
}

func (v *NullableRuntimeJSONRPCBusinessError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuntimeJSONRPCBusinessError(val *RuntimeJSONRPCBusinessError) *NullableRuntimeJSONRPCBusinessError {
	return &NullableRuntimeJSONRPCBusinessError{value: val, isSet: true}
}

func (v NullableRuntimeJSONRPCBusinessError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuntimeJSONRPCBusinessError) UnmarshalJSON(src []byte) error {
	v.isSet = true

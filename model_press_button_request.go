...
// checks if the PressButtonRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PressButtonRequest{}

// PressButtonRequest struct for PressButtonRequest
type PressButtonRequest struct {
	// Hardware / nav button name (`back` / `home` / `recent` / `power` / `volume_up` / `volume_down` / `enter`). 
	Button string `json:"button"`
}

type _PressButtonRequest PressButtonRequest
...
func (o PressButtonRequest) MarshalJSON() ([]byte, error) {
...
func (o PressButtonRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["button"] = o.Button
	return toSerialize, nil
}

func (o *PressButtonRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPressButtonRequest := _PressButtonRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPressButtonRequest)

	if err != nil {
		return err
	}

	*o = PressButtonRequest(varPressButtonRequest)

	return err
}

type NullablePressButtonRequest struct {
	value *PressButtonRequest
	isSet bool
}

func (v NullablePressButtonRequest) Get() *PressButtonRequest {
	return v.value
}

func (v *NullablePressButtonRequest) Set(val *PressButtonRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePressButtonRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePressButtonRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePressButtonRequest(val *PressButtonRequest) *NullablePressButtonRequest {
	return &NullablePressButtonRequest{value: val, isSet: true}
}

func (v NullablePressButtonRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePressButtonRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

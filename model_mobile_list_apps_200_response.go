...
// checks if the MobileListApps200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MobileListApps200Response{}

// MobileListApps200Response struct for MobileListApps200Response
type MobileListApps200Response struct {
	Success bool           `json:"success"`
	Data    *AppListResult `json:"data,omitempty"`
}

type _MobileListApps200Response MobileListApps200Response
...
func NewMobileListApps200Response(success bool) *MobileListApps200Response {
	this := MobileListApps200Response{}
...
func (o MobileListApps200Response) MarshalJSON() ([]byte, error) {
...
func (o MobileListApps200Response) ToMap() (map[string]interface{}, error) {
...
func (o *MobileListApps200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varMobileListApps200Response := _MobileListApps200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMobileListApps200Response)

	if err != nil {
		return err
	}

	*o = MobileListApps200Response(varMobileListApps200Response)

	return err
}

type NullableMobileListApps200Response struct {
	value *MobileListApps200Response
	isSet bool
}

func (v NullableMobileListApps200Response) Get() *MobileListApps200Response {
	return v.value
}

func (v *NullableMobileListApps200Response) Set(val *MobileListApps200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMobileListApps200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMobileListApps200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMobileListApps200Response(val *MobileListApps200Response) *NullableMobileListApps200Response {
	return &NullableMobileListApps200Response{value: val, isSet: true}
}

func (v NullableMobileListApps200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMobileListApps200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

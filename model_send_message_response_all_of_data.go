...
// checks if the SendMessageResponseAllOfData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendMessageResponseAllOfData{}

// SendMessageResponseAllOfData struct for SendMessageResponseAllOfData
type SendMessageResponseAllOfData struct {
	MessageId string `json:"message_id"`
	CreatedAt *time.Time `json:"created_at,omitempty"`
}

type _SendMessageResponseAllOfData SendMessageResponseAllOfData
...
func NewSendMessageResponseAllOfData(messageId string) *SendMessageResponseAllOfData {
	this := SendMessageResponseAllOfData{}
...
func (o SendMessageResponseAllOfData) MarshalJSON() ([]byte, error) {
...
func (o SendMessageResponseAllOfData) ToMap() (map[string]interface{}, error) {
...
func (o *SendMessageResponseAllOfData) UnmarshalJSON(data []byte) (err error) {
	...
	varSendMessageResponseAllOfData := _SendMessageResponseAllOfData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSendMessageResponseAllOfData)

	if err != nil {
		return err
	}

	*o = SendMessageResponseAllOfData(varSendMessageResponseAllOfData)

	return err
}

type NullableSendMessageResponseAllOfData struct {
	value *SendMessageResponseAllOfData
	isSet bool
}

func (v NullableSendMessageResponseAllOfData) Get() *SendMessageResponseAllOfData {
	return v.value
}

func (v *NullableSendMessageResponseAllOfData) Set(val *SendMessageResponseAllOfData) {
	v.value = val
	v.isSet = true
}

func (v NullableSendMessageResponseAllOfData) IsSet() bool {
	return v.isSet
}

func (v *NullableSendMessageResponseAllOfData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendMessageResponseAllOfData(val *SendMessageResponseAllOfData) *NullableSendMessageResponseAllOfData {
	return &NullableSendMessageResponseAllOfData{value: val, isSet: true}
}

func (v NullableSendMessageResponseAllOfData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendMessageResponseAllOfData) UnmarshalJSON(src []byte) error {
	v.isSet = true

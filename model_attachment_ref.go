...
type AttachmentRef struct {
	// File identifier returned from [`POST /api/v1/files/presign-upload`](#operation/presignFileUpload). 
	FileId string `json:"file_id"`
	// Optional override for the file_record's filename.
	Filename *string `json:"filename,omitempty"`
	// Optional override for the file_record's MIME type.

...
// checks if the PartCustom type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartCustom{}

// PartCustom Extension escape hatch. New structured payloads (step markers, artifact refs, audio frames, code edits, …) can be carried under `custom.kind` without a schema migration. Old consumers SHOULD skip unrecognised kinds; new consumers route by `kind`. 
type PartCustom struct {
	Type string `json:"type"`
	// Caller-controlled extension discriminant.
	Kind string `json:"kind"`
	Data interface{} `json:"data"`
}

type _PartCustom PartCustom

// NewPartCustom instantiates a new PartCustom object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPartCustom(type_ string, kind string, data interface{}) *PartCustom {
	this := PartCustom{}
	this.Type = type_
	this.Kind = kind
	this.Data = data
...
// NewPartCustomWithDefaults instantiates a new PartCustom object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPartCustomWithDefaults() *PartCustom {
	this := PartCustom{}
	return &this
}

// GetType returns the Type field value
func (o *PartCustom) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *PartCustom) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *PartCustom) SetType(v string) {
	o.Type = v
}

// GetKind returns the Kind field value
func (o *PartCustom) GetKind() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PartCustom) GetKindOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Kind, true
...
func (o *PartCustom) SetKind(v string) {
	o.Kind = v
}

// GetData returns the Data field value
// If the value is explicit nil, the zero value for interface{} will be returned
func (o *PartCustom) GetData() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *PartCustom) GetDataOk() (*interface{}, bool) {
...
func (o *PartCustom) SetData(v interface{}) {
	o.Data = v
}

func (o PartCustom) MarshalJSON() ([]byte, error) {
...
func (o PartCustom) ToMap() (map[string]interface{}, error) {
...
func (o *PartCustom) UnmarshalJSON(data []byte) (err error) {
	...
	varPartCustom := _PartCustom{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPartCustom)

	if err != nil {
		return err
	}

	*o = PartCustom(varPartCustom)

	return err
}

type NullablePartCustom struct {
	value *PartCustom
	isSet bool
}

func (v NullablePartCustom) Get() *PartCustom {
	return v.value
}

func (v *NullablePartCustom) Set(val *PartCustom) {
	v.value = val
	v.isSet = true
}

func (v NullablePartCustom) IsSet() bool {
	return v.isSet
}

func (v *NullablePartCustom) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartCustom(val *PartCustom) *NullablePartCustom {
	return &NullablePartCustom{value: val, isSet: true}
}

func (v NullablePartCustom) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartCustom) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ListWebhookDeliveriesResponseAllOfData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListWebhookDeliveriesResponseAllOfData{}

// ListWebhookDeliveriesResponseAllOfData struct for ListWebhookDeliveriesResponseAllOfData
type ListWebhookDeliveriesResponseAllOfData struct {
	Deliveries []WebhookDeliveryResponse `json:"deliveries"`
}

type _ListWebhookDeliveriesResponseAllOfData ListWebhookDeliveriesResponseAllOfData

// NewListWebhookDeliveriesResponseAllOfData instantiates a new ListWebhookDeliveriesResponseAllOfData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListWebhookDeliveriesResponseAllOfData(deliveries []WebhookDeliveryResponse) *ListWebhookDeliveriesResponseAllOfData {
	this := ListWebhookDeliveriesResponseAllOfData{}
	this.Deliveries = deliveries
	return &this
}

// NewListWebhookDeliveriesResponseAllOfDataWithDefaults instantiates a new ListWebhookDeliveriesResponseAllOfData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListWebhookDeliveriesResponseAllOfDataWithDefaults() *ListWebhookDeliveriesResponseAllOfData {
	this := ListWebhookDeliveriesResponseAllOfData{}
	return &this
}

// GetDeliveries returns the Deliveries field value
func (o *ListWebhookDeliveriesResponseAllOfData) GetDeliveries() []WebhookDeliveryResponse {
	if o == nil {
...
func (o *ListWebhookDeliveriesResponseAllOfData) GetDeliveriesOk() ([]WebhookDeliveryResponse, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListWebhookDeliveriesResponseAllOfData) SetDeliveries(v []WebhookDeliveryResponse) {
	o.Deliveries = v
}

func (o ListWebhookDeliveriesResponseAllOfData) MarshalJSON() ([]byte, error) {
...
func (o ListWebhookDeliveriesResponseAllOfData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["deliveries"] = o.Deliveries
	return toSerialize, nil
}

func (o *ListWebhookDeliveriesResponseAllOfData) UnmarshalJSON(data []byte) (err error) {
	...
	varListWebhookDeliveriesResponseAllOfData := _ListWebhookDeliveriesResponseAllOfData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListWebhookDeliveriesResponseAllOfData)

	if err != nil {
		return err
	}

	*o = ListWebhookDeliveriesResponseAllOfData(varListWebhookDeliveriesResponseAllOfData)

	return err
}

type NullableListWebhookDeliveriesResponseAllOfData struct {
	value *ListWebhookDeliveriesResponseAllOfData
	isSet bool
}

func (v NullableListWebhookDeliveriesResponseAllOfData) Get() *ListWebhookDeliveriesResponseAllOfData {
	return v.value
}

func (v *NullableListWebhookDeliveriesResponseAllOfData) Set(val *ListWebhookDeliveriesResponseAllOfData) {
	v.value = val
	v.isSet = true
}

func (v NullableListWebhookDeliveriesResponseAllOfData) IsSet() bool {
	return v.isSet
}

func (v *NullableListWebhookDeliveriesResponseAllOfData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListWebhookDeliveriesResponseAllOfData(val *ListWebhookDeliveriesResponseAllOfData) *NullableListWebhookDeliveriesResponseAllOfData {
	return &NullableListWebhookDeliveriesResponseAllOfData{value: val, isSet: true}
}

func (v NullableListWebhookDeliveriesResponseAllOfData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListWebhookDeliveriesResponseAllOfData) UnmarshalJSON(src []byte) error {
	v.isSet = true

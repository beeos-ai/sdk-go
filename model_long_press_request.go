...
// checks if the LongPressRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LongPressRequest{}

// LongPressRequest struct for LongPressRequest
type LongPressRequest struct {
	X int32 `json:"x"`
	Y int32 `json:"y"`
	// Hold duration; clamped device-side to [1, 10000].
	DurationMs *int32 `json:"duration_ms,omitempty"`
}

type _LongPressRequest LongPressRequest
...
func (o LongPressRequest) MarshalJSON() ([]byte, error) {
...
func (o LongPressRequest) ToMap() (map[string]interface{}, error) {
...
func (o *LongPressRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varLongPressRequest := _LongPressRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLongPressRequest)

	if err != nil {
		return err
	}

	*o = LongPressRequest(varLongPressRequest)

	return err
}

type NullableLongPressRequest struct {
	value *LongPressRequest
	isSet bool
}

func (v NullableLongPressRequest) Get() *LongPressRequest {
	return v.value
}

func (v *NullableLongPressRequest) Set(val *LongPressRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableLongPressRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableLongPressRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLongPressRequest(val *LongPressRequest) *NullableLongPressRequest {
	return &NullableLongPressRequest{value: val, isSet: true}
}

func (v NullableLongPressRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLongPressRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

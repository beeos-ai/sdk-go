...
type UpdateAgentRequest struct {
	// Agent ACL bucket. `private` is owner-only; `public` lets any authenticated caller invoke; `unlisted` is invokable but absent from public listings; `marketplace` is catalog-visible. 
...
type _UpdateAgentRequest UpdateAgentRequest
...
// GetMcpEnabled returns the McpEnabled field value if set, zero value otherwise.
func (o *UpdateAgentRequest) GetMcpEnabled() bool {
	if o == nil || IsNil(o.McpEnabled) {
		var ret bool
		return ret
	}
	return *o.McpEnabled
...
// GetMcpEnabledOk returns a tuple with the McpEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMcpEnabled gets a reference to the given bool and assigns it to the McpEnabled field.
...
func (o *UpdateAgentRequest) UnmarshalJSON(data []byte) (err error) {
	varUpdateAgentRequest := _UpdateAgentRequest{}

	err = json.Unmarshal(data, &varUpdateAgentRequest)

	if err != nil {
		return err
	}

	*o = UpdateAgentRequest(varUpdateAgentRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "mcp_enabled")

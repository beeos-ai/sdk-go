...
// checks if the ListTaskWebhooksResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTaskWebhooksResponse{}

// ListTaskWebhooksResponse struct for ListTaskWebhooksResponse
type ListTaskWebhooksResponse struct {
	Success bool `json:"success"`
	Data ListTaskWebhooksResponseAllOfData `json:"data"`
}

type _ListTaskWebhooksResponse ListTaskWebhooksResponse
...
func (o *ListTaskWebhooksResponse) GetData() ListTaskWebhooksResponseAllOfData {
	if o == nil {
		var ret ListTaskWebhooksResponseAllOfData
		return ret
	}
...
func (o ListTaskWebhooksResponse) MarshalJSON() ([]byte, error) {
...
func (o ListTaskWebhooksResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ListTaskWebhooksResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListTaskWebhooksResponse := _ListTaskWebhooksResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTaskWebhooksResponse)

	if err != nil {
		return err
	}

	*o = ListTaskWebhooksResponse(varListTaskWebhooksResponse)

	return err
}

type NullableListTaskWebhooksResponse struct {
	value *ListTaskWebhooksResponse
	isSet bool
}

func (v NullableListTaskWebhooksResponse) Get() *ListTaskWebhooksResponse {
	return v.value
}

func (v *NullableListTaskWebhooksResponse) Set(val *ListTaskWebhooksResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListTaskWebhooksResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListTaskWebhooksResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTaskWebhooksResponse(val *ListTaskWebhooksResponse) *NullableListTaskWebhooksResponse {
	return &NullableListTaskWebhooksResponse{value: val, isSet: true}
}

func (v NullableListTaskWebhooksResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTaskWebhooksResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

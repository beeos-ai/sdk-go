...
// checks if the CancelConversation202Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelConversation202Response{}

// CancelConversation202Response struct for CancelConversation202Response
type CancelConversation202Response struct {
	Success bool `json:"success"`
	Data CancelConversation202ResponseData `json:"data"`
	AdditionalProperties map[string]interface{}
}

type _CancelConversation202Response CancelConversation202Response

// NewCancelConversation202Response instantiates a new CancelConversation202Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCancelConversation202Response(success bool, data CancelConversation202ResponseData) *CancelConversation202Response {
	this := CancelConversation202Response{}
	this.Success = success
	this.Data = data
	return &this
}

// NewCancelConversation202ResponseWithDefaults instantiates a new CancelConversation202Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCancelConversation202ResponseWithDefaults() *CancelConversation202Response {
	this := CancelConversation202Response{}
	return &this
}

// GetSuccess returns the Success field value
func (o *CancelConversation202Response) GetSuccess() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
func (o *CancelConversation202Response) GetSuccessOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CancelConversation202Response) SetSuccess(v bool) {
	o.Success = v
}

// GetData returns the Data field value
func (o *CancelConversation202Response) GetData() CancelConversation202ResponseData {
	if o == nil {
		var ret CancelConversation202ResponseData
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CancelConversation202Response) GetDataOk() (*CancelConversation202ResponseData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *CancelConversation202Response) SetData(v CancelConversation202ResponseData) {
	o.Data = v
}

func (o CancelConversation202Response) MarshalJSON() ([]byte, error) {
...
func (o CancelConversation202Response) ToMap() (map[string]interface{}, error) {
...
func (o *CancelConversation202Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCancelConversation202Response := _CancelConversation202Response{}

	err = json.Unmarshal(data, &varCancelConversation202Response)

	if err != nil {
		return err
	}

	*o = CancelConversation202Response(varCancelConversation202Response)
...
type NullableCancelConversation202Response struct {
	value *CancelConversation202Response
	isSet bool
}

func (v NullableCancelConversation202Response) Get() *CancelConversation202Response {
	return v.value
}

func (v *NullableCancelConversation202Response) Set(val *CancelConversation202Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelConversation202Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelConversation202Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelConversation202Response(val *CancelConversation202Response) *NullableCancelConversation202Response {
	return &NullableCancelConversation202Response{value: val, isSet: true}
}

func (v NullableCancelConversation202Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelConversation202Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ServiceOperationsListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceOperationsListResponse{}

// ServiceOperationsListResponse struct for ServiceOperationsListResponse
type ServiceOperationsListResponse struct {
	Operations []RuntimeOperationSnapshot `json:"operations"`
	NextCursor *string `json:"nextCursor,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ServiceOperationsListResponse ServiceOperationsListResponse
...
func NewServiceOperationsListResponse(operations []RuntimeOperationSnapshot) *ServiceOperationsListResponse {
	this := ServiceOperationsListResponse{}
...
func (o *ServiceOperationsListResponse) GetOperations() []RuntimeOperationSnapshot {
	if o == nil {
		var ret []RuntimeOperationSnapshot
		return ret
	}
...
func (o ServiceOperationsListResponse) MarshalJSON() ([]byte, error) {
...
func (o ServiceOperationsListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ServiceOperationsListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varServiceOperationsListResponse := _ServiceOperationsListResponse{}

	err = json.Unmarshal(data, &varServiceOperationsListResponse)

	if err != nil {
		return err
	}

	*o = ServiceOperationsListResponse(varServiceOperationsListResponse)
...
type NullableServiceOperationsListResponse struct {
	value *ServiceOperationsListResponse
	isSet bool
}

func (v NullableServiceOperationsListResponse) Get() *ServiceOperationsListResponse {
	return v.value
}

func (v *NullableServiceOperationsListResponse) Set(val *ServiceOperationsListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceOperationsListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceOperationsListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceOperationsListResponse(val *ServiceOperationsListResponse) *NullableServiceOperationsListResponse {
	return &NullableServiceOperationsListResponse{value: val, isSet: true}
}

func (v NullableServiceOperationsListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceOperationsListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

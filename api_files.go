...
func (r ApiGetFileRequest) Execute() (*GetFile200Response, *http.Response, error) {
	return r.ApiService.GetFileExecute(r)
}

/*
GetFile Resolve a file_id to metadata + presigned download URL.

Returns the filename / content-type / size of a previously uploaded
file along with a presigned GET URL (TTL set by the storage
backend, typically 24h on S3). Agents receive the same URL when
the file is attached to an invoke / task envelope; this endpoint
exists so callers can fetch their own uploads back without going
through an agent.
...
func (a *FilesAPIService) GetFileExecute(r ApiGetFileRequest) (*GetFile200Response, *http.Response, error) {
	var (
...
func (r ApiPresignFileUploadRequest) PresignUploadRequest(presignUploadRequest PresignUploadRequest) ApiPresignFileUploadRequest {
	r.presignUploadRequest = &presignUploadRequest
	return r
}

func (r ApiPresignFileUploadRequest) Execute() (*PresignFileUpload200Response, *http.Response, error) {
	return r.ApiService.PresignFileUploadExecute(r)
}

/*
PresignFileUpload Request a presigned upload URL.
...
field — see [docs/guides/calling-agents.md](../../docs/guides/calling-agents.md)
...
*/
func (a *FilesAPIService) PresignFileUpload(ctx context.Context) ApiPresignFileUploadRequest {
	return ApiPresignFileUploadRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PresignFileUpload200Response
func (a *FilesAPIService) PresignFileUploadExecute(r ApiPresignFileUploadRequest) (*PresignFileUpload200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PresignFileUpload200Response
	)
	...
	localVarPath := localBasePath + "/api/v1/files/presign-upload"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.presignUploadRequest == nil {
		return localVarReturnValue, nil, reportError("presignUploadRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.presignUploadRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}

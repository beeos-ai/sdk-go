...
// checks if the TypeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TypeRequest{}

// TypeRequest struct for TypeRequest
type TypeRequest struct {
	Text string `json:"text"`
	// When true, press ENTER after typing.
	Submit *bool `json:"submit,omitempty"`
}

type _TypeRequest TypeRequest
...
func (o TypeRequest) MarshalJSON() ([]byte, error) {
...
func (o TypeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *TypeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTypeRequest := _TypeRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTypeRequest)

	if err != nil {
		return err
	}

	*o = TypeRequest(varTypeRequest)

	return err
}

type NullableTypeRequest struct {
	value *TypeRequest
	isSet bool
}

func (v NullableTypeRequest) Get() *TypeRequest {
	return v.value
}

func (v *NullableTypeRequest) Set(val *TypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTypeRequest(val *TypeRequest) *NullableTypeRequest {
	return &NullableTypeRequest{value: val, isSet: true}
}

func (v NullableTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the SetConversationModelRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetConversationModelRequest{}

// SetConversationModelRequest struct for SetConversationModelRequest
type SetConversationModelRequest struct {
	ModelOverrideId string `json:"modelOverrideId"`
	AdditionalProperties map[string]interface{}
}

type _SetConversationModelRequest SetConversationModelRequest

// NewSetConversationModelRequest instantiates a new SetConversationModelRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSetConversationModelRequest(modelOverrideId string) *SetConversationModelRequest {
	this := SetConversationModelRequest{}
	this.ModelOverrideId = modelOverrideId
	return &this
}

// NewSetConversationModelRequestWithDefaults instantiates a new SetConversationModelRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSetConversationModelRequestWithDefaults() *SetConversationModelRequest {
	this := SetConversationModelRequest{}
	return &this
}

// GetModelOverrideId returns the ModelOverrideId field value
func (o *SetConversationModelRequest) GetModelOverrideId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// GetModelOverrideIdOk returns a tuple with the ModelOverrideId field value
// and a boolean to check if the value has been set.
func (o *SetConversationModelRequest) GetModelOverrideIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// SetModelOverrideId sets field value
func (o *SetConversationModelRequest) SetModelOverrideId(v string) {
	o.ModelOverrideId = v
}

func (o SetConversationModelRequest) MarshalJSON() ([]byte, error) {
...
func (o SetConversationModelRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SetConversationModelRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSetConversationModelRequest := _SetConversationModelRequest{}

	err = json.Unmarshal(data, &varSetConversationModelRequest)

	if err != nil {
		return err
	}

	*o = SetConversationModelRequest(varSetConversationModelRequest)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "modelOverrideId")
...
type NullableSetConversationModelRequest struct {
	value *SetConversationModelRequest
	isSet bool
}

func (v NullableSetConversationModelRequest) Get() *SetConversationModelRequest {
	return v.value
}

func (v *NullableSetConversationModelRequest) Set(val *SetConversationModelRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSetConversationModelRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSetConversationModelRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetConversationModelRequest(val *SetConversationModelRequest) *NullableSetConversationModelRequest {
	return &NullableSetConversationModelRequest{value: val, isSet: true}
}

func (v NullableSetConversationModelRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetConversationModelRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

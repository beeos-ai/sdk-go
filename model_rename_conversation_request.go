...
// checks if the RenameConversationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RenameConversationRequest{}

// RenameConversationRequest struct for RenameConversationRequest
type RenameConversationRequest struct {
	Title string `json:"title"`
	AdditionalProperties map[string]interface{}
}

type _RenameConversationRequest RenameConversationRequest
...
func NewRenameConversationRequest(title string) *RenameConversationRequest {
	this := RenameConversationRequest{}
	this.Title = title
	return &this
}
...
func (o RenameConversationRequest) MarshalJSON() ([]byte, error) {
...
func (o RenameConversationRequest) ToMap() (map[string]interface{}, error) {
...
func (o *RenameConversationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRenameConversationRequest := _RenameConversationRequest{}

	err = json.Unmarshal(data, &varRenameConversationRequest)

	if err != nil {
		return err
	}

	*o = RenameConversationRequest(varRenameConversationRequest)
...
type NullableRenameConversationRequest struct {
	value *RenameConversationRequest
	isSet bool
}

func (v NullableRenameConversationRequest) Get() *RenameConversationRequest {
	return v.value
}

func (v *NullableRenameConversationRequest) Set(val *RenameConversationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRenameConversationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRenameConversationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRenameConversationRequest(val *RenameConversationRequest) *NullableRenameConversationRequest {
	return &NullableRenameConversationRequest{value: val, isSet: true}
}

func (v NullableRenameConversationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRenameConversationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ListWebhookDeliveriesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListWebhookDeliveriesResponse{}

// ListWebhookDeliveriesResponse struct for ListWebhookDeliveriesResponse
type ListWebhookDeliveriesResponse struct {
	Success bool `json:"success"`
	Data ListWebhookDeliveriesResponseAllOfData `json:"data"`
}

type _ListWebhookDeliveriesResponse ListWebhookDeliveriesResponse
...
func NewListWebhookDeliveriesResponse(success bool, data ListWebhookDeliveriesResponseAllOfData) *ListWebhookDeliveriesResponse {
	this := ListWebhookDeliveriesResponse{}
...
func (o *ListWebhookDeliveriesResponse) GetData() ListWebhookDeliveriesResponseAllOfData {
	if o == nil {
		var ret ListWebhookDeliveriesResponseAllOfData
		return ret
	}
...
func (o ListWebhookDeliveriesResponse) MarshalJSON() ([]byte, error) {
...
func (o ListWebhookDeliveriesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ListWebhookDeliveriesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ListWebhookDeliveriesResponse(varListWebhookDeliveriesResponse)

	return err
}

type NullableListWebhookDeliveriesResponse struct {
	value *ListWebhookDeliveriesResponse
	isSet bool
}

func (v NullableListWebhookDeliveriesResponse) Get() *ListWebhookDeliveriesResponse {
	return v.value
}

func (v *NullableListWebhookDeliveriesResponse) Set(val *ListWebhookDeliveriesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListWebhookDeliveriesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListWebhookDeliveriesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListWebhookDeliveriesResponse(val *ListWebhookDeliveriesResponse) *NullableListWebhookDeliveriesResponse {
	return &NullableListWebhookDeliveriesResponse{value: val, isSet: true}
}

func (v NullableListWebhookDeliveriesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListWebhookDeliveriesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

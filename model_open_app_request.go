...
// checks if the OpenAppRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenAppRequest{}

// OpenAppRequest struct for OpenAppRequest
type OpenAppRequest struct {
	// Android package id or installed app display name.
	App      string  `json:"app"`
	Activity *string `json:"activity,omitempty"`
	// Optional BCP-47 per-app locale (Android 13+, best effort).
	Locale *string `json:"locale,omitempty"`
}

type _OpenAppRequest OpenAppRequest
...
func (o OpenAppRequest) MarshalJSON() ([]byte, error) {
...
func (o OpenAppRequest) ToMap() (map[string]interface{}, error) {
...
func (o *OpenAppRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenAppRequest := _OpenAppRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpenAppRequest)

	if err != nil {
		return err
	}

	*o = OpenAppRequest(varOpenAppRequest)

	return err
}

type NullableOpenAppRequest struct {
	value *OpenAppRequest
	isSet bool
}

func (v NullableOpenAppRequest) Get() *OpenAppRequest {
	return v.value
}

func (v *NullableOpenAppRequest) Set(val *OpenAppRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenAppRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenAppRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenAppRequest(val *OpenAppRequest) *NullableOpenAppRequest {
	return &NullableOpenAppRequest{value: val, isSet: true}
}

func (v NullableOpenAppRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenAppRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the CancelConversationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelConversationRequest{}

// CancelConversationRequest struct for CancelConversationRequest
...
type _CancelConversationRequest CancelConversationRequest
...
func (o CancelConversationRequest) MarshalJSON() ([]byte, error) {
...
func (o CancelConversationRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CancelConversationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCancelConversationRequest := _CancelConversationRequest{}

	err = json.Unmarshal(data, &varCancelConversationRequest)

	if err != nil {
		return err
	}

	*o = CancelConversationRequest(varCancelConversationRequest)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "target_message_id")
...
type NullableCancelConversationRequest struct {
	value *CancelConversationRequest
	isSet bool
}

func (v NullableCancelConversationRequest) Get() *CancelConversationRequest {
	return v.value
}

func (v *NullableCancelConversationRequest) Set(val *CancelConversationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelConversationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelConversationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelConversationRequest(val *CancelConversationRequest) *NullableCancelConversationRequest {
	return &NullableCancelConversationRequest{value: val, isSet: true}
}

func (v NullableCancelConversationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelConversationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

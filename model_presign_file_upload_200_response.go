...
// checks if the PresignFileUpload200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PresignFileUpload200Response{}

// PresignFileUpload200Response struct for PresignFileUpload200Response
type PresignFileUpload200Response struct {
	Success bool `json:"success"`
	Data *PresignUploadResponse `json:"data,omitempty"`
}

type _PresignFileUpload200Response PresignFileUpload200Response
...
func NewPresignFileUpload200Response(success bool) *PresignFileUpload200Response {
	this := PresignFileUpload200Response{}
...
// SetData gets a reference to the given PresignUploadResponse and assigns it to the Data field.
func (o *PresignFileUpload200Response) SetData(v PresignUploadResponse) {
	o.Data = &v
}

func (o PresignFileUpload200Response) MarshalJSON() ([]byte, error) {
...
func (o PresignFileUpload200Response) ToMap() (map[string]interface{}, error) {
...
func (o *PresignFileUpload200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varPresignFileUpload200Response := _PresignFileUpload200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPresignFileUpload200Response)

	if err != nil {
		return err
	}

	*o = PresignFileUpload200Response(varPresignFileUpload200Response)

	return err
}

type NullablePresignFileUpload200Response struct {
	value *PresignFileUpload200Response
	isSet bool
}

func (v NullablePresignFileUpload200Response) Get() *PresignFileUpload200Response {
	return v.value
}

func (v *NullablePresignFileUpload200Response) Set(val *PresignFileUpload200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePresignFileUpload200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePresignFileUpload200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePresignFileUpload200Response(val *PresignFileUpload200Response) *NullablePresignFileUpload200Response {
	return &NullablePresignFileUpload200Response{value: val, isSet: true}
}

func (v NullablePresignFileUpload200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePresignFileUpload200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

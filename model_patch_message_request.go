...
// checks if the PatchMessageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchMessageRequest{}

// PatchMessageRequest Request body for `PATCH /api/v3/conversations/{cid}/messages/{mid}`. All fields are optional; the wire is SNAPSHOT-based — each PATCH carries the full cumulative body + parts the server should persist (NOT an indexed delta).  Returns `410 Gone` (`code = message_terminal`) if the row is already in a terminal state. 
...
func (o PatchMessageRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchMessageRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePatchMessageRequest struct {
	value *PatchMessageRequest
	isSet bool
}

func (v NullablePatchMessageRequest) Get() *PatchMessageRequest {
	return v.value
}

func (v *NullablePatchMessageRequest) Set(val *PatchMessageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchMessageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchMessageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchMessageRequest(val *PatchMessageRequest) *NullablePatchMessageRequest {
	return &NullablePatchMessageRequest{value: val, isSet: true}
}

func (v NullablePatchMessageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchMessageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
type AgentListResponse struct {
	...
	Projection *InstanceProjectionMetadata `json:"projection,omitempty"`
}
...
func (o *AgentListResponse) GetProjection() InstanceProjectionMetadata {
	if o == nil || IsNil(o.Projection) {
		var ret InstanceProjectionMetadata
		return ret
	}
	return *o.Projection
}
...
// SetProjection gets a reference to the given InstanceProjectionMetadata and assigns it to the Projection field.

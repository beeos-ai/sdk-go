...
// checks if the PartToolResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartToolResult{}

// PartToolResult Tool-call output, paired with the originating tool_use via `tool_use_id`.
type PartToolResult struct {
	Type string `json:"type"`
	ToolUseId string `json:"tool_use_id"`
	Content PartToolResultContent `json:"content"`
	// True iff the tool call errored (model should treat as such).
	IsError *bool `json:"is_error,omitempty"`
}

type _PartToolResult PartToolResult
...
func (o PartToolResult) MarshalJSON() ([]byte, error) {
...
func (o PartToolResult) ToMap() (map[string]interface{}, error) {
...
func (o *PartToolResult) UnmarshalJSON(data []byte) (err error) {
	...
	varPartToolResult := _PartToolResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPartToolResult)

	if err != nil {
		return err
	}

	*o = PartToolResult(varPartToolResult)

	return err
}

type NullablePartToolResult struct {
	value *PartToolResult
	isSet bool
}

func (v NullablePartToolResult) Get() *PartToolResult {
	return v.value
}

func (v *NullablePartToolResult) Set(val *PartToolResult) {
	v.value = val
	v.isSet = true
}

func (v NullablePartToolResult) IsSet() bool {
	return v.isSet
}

func (v *NullablePartToolResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartToolResult(val *PartToolResult) *NullablePartToolResult {
	return &NullablePartToolResult{value: val, isSet: true}
}

func (v NullablePartToolResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartToolResult) UnmarshalJSON(src []byte) error {
	v.isSet = true

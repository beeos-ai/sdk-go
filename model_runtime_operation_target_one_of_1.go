...
// checks if the RuntimeOperationTargetOneOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuntimeOperationTargetOneOf1{}

// RuntimeOperationTargetOneOf1 struct for RuntimeOperationTargetOneOf1
type RuntimeOperationTargetOneOf1 struct {
	Scope string `json:"scope"`
	PlatformAgentId string `json:"platformAgentId"`
	AdditionalProperties map[string]interface{}
}

type _RuntimeOperationTargetOneOf1 RuntimeOperationTargetOneOf1

// NewRuntimeOperationTargetOneOf1 instantiates a new RuntimeOperationTargetOneOf1 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRuntimeOperationTargetOneOf1(scope string, platformAgentId string) *RuntimeOperationTargetOneOf1 {
	this := RuntimeOperationTargetOneOf1{}
	this.Scope = scope
	this.PlatformAgentId = platformAgentId
	return &this
}

// NewRuntimeOperationTargetOneOf1WithDefaults instantiates a new RuntimeOperationTargetOneOf1 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRuntimeOperationTargetOneOf1WithDefaults() *RuntimeOperationTargetOneOf1 {
	this := RuntimeOperationTargetOneOf1{}
	return &this
}

// GetScope returns the Scope field value
func (o *RuntimeOperationTargetOneOf1) GetScope() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *RuntimeOperationTargetOneOf1) GetScopeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Scope, true
...
func (o *RuntimeOperationTargetOneOf1) SetScope(v string) {
	o.Scope = v
}

// GetPlatformAgentId returns the PlatformAgentId field value
func (o *RuntimeOperationTargetOneOf1) GetPlatformAgentId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RuntimeOperationTargetOneOf1) GetPlatformAgentIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RuntimeOperationTargetOneOf1) SetPlatformAgentId(v string) {
	o.PlatformAgentId = v
}

func (o RuntimeOperationTargetOneOf1) MarshalJSON() ([]byte, error) {
...
func (o RuntimeOperationTargetOneOf1) ToMap() (map[string]interface{}, error) {
...
func (o *RuntimeOperationTargetOneOf1) UnmarshalJSON(data []byte) (err error) {
	...
	varRuntimeOperationTargetOneOf1 := _RuntimeOperationTargetOneOf1{}

	err = json.Unmarshal(data, &varRuntimeOperationTargetOneOf1)

	if err != nil {
		return err
	}

	*o = RuntimeOperationTargetOneOf1(varRuntimeOperationTargetOneOf1)
...
type NullableRuntimeOperationTargetOneOf1 struct {
	value *RuntimeOperationTargetOneOf1
	isSet bool
}

func (v NullableRuntimeOperationTargetOneOf1) Get() *RuntimeOperationTargetOneOf1 {
	return v.value
}

func (v *NullableRuntimeOperationTargetOneOf1) Set(val *RuntimeOperationTargetOneOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableRuntimeOperationTargetOneOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableRuntimeOperationTargetOneOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuntimeOperationTargetOneOf1(val *RuntimeOperationTargetOneOf1) *NullableRuntimeOperationTargetOneOf1 {
	return &NullableRuntimeOperationTargetOneOf1{value: val, isSet: true}
}

func (v NullableRuntimeOperationTargetOneOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuntimeOperationTargetOneOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
